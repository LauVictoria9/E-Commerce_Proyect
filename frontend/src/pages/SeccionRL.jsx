...
export default function SeccionRL() {
  ...
  useEffect(() => {
    ...
    const obtenerProductos = async () => {
      ...
      const response = await obtenerProductosTipo("refrigeracion liquida", 8);
      ...
      setComponentesRL(productosPorPagina);
    };
  ...
  return componentesRL ? (
    <main className="pt-8 pb-16 ">
      ...
      <section className="">
        ...
        {componentesRL.map((componentesRL, index) => (
          <>
            {console.log(componentesRL.id)}
            <div key={index} className="flex">
              ...
              >
                ...
                <Slider sliderId={index} data={componentesRL} />
              </div>
            </div>
            <div className="h-16" />
          </>
