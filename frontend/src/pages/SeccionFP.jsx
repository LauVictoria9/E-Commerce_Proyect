...
/* Item data temp */
import { itemDataFP, itemDataFP1, itemDataFP2 } from "../layout/data";
      ...
      <section className="">
        <div className="flex">
          ...
          <div className="w-full md:w-2/3 items-center relative flex">
            ...
            <Slider sliderId="promo_one" data={itemDataFP} />
          </div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="w-full md:w-4/% items-center relative flex">
            ...
            <Slider sliderId="promo_two" data={itemDataFP1} />
          </div>
        </div>
        <div className="h-16" />
        ...
        <div className="flex">
          ...
          <div className="w-full md:w-4/% items-center relative flex">
            ...
            <Slider sliderId="promo_three" data={itemDataFP2} />
          </div>
        </div>
      </section>
    </main>
