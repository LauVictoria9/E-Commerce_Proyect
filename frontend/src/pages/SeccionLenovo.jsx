...
export default function SeccionLenovo() {
  const [portatilesLenovo, setPortatilesLenovo] = useState([]);
  ...
  useEffect(() => {
    ...
    const obtenerProductos = async () => {
      ...
      const response = await obtenerProductosMarcaTipo("lenovo", "portatil", 8);
      ...
      setPortatilesLenovo(productosPorPagina);
    };
  ...
  return portatilesLenovo ? (
    <main className="pt-8 pb-16 ">
      ...
      <section className="">
        ...
        {portatilesLenovo.map((portatilesLenovo, index) => (
          <>
            {console.log(portatilesLenovo.id)}
            <div key={index} className="flex">
              ...
              >
                ...
                <Slider sliderId={index} data={portatilesLenovo} />
              </div>
            </div>
            <div className="h-16" />
          </>
