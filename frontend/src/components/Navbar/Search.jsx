      ...
      <div /*class="relative px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:px-10"*/> 
        <div className="mx-auto max-w-md">   
          <form action="" className="relative mx-auto w-max">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="absolute inset-y-0 my-auto h-8 w-12 border-transparent px-3.5 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
